...
import com.gravity.billeasy.domain_layer.entities.OrderedProductEntity
...
@Database(
    entities = [ProductEntity::class, ShopEntity::class, BillEntity::class, OrderedProductEntity::class],
    version = DB_VERSION,
    exportSchema = true
)
    ...
    fun getDatabase(context: Context): AppDatabase {
        return INSTANCE ?: synchronized(this) {
            val instance = Room.databaseBuilder(
                ...
                .addMigrations(dbMigrationImpl.migrateFrom_6_7()).build()
            INSTANCE = instance
            instance
        }
    }
